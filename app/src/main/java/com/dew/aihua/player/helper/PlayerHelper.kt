...
object PlayerHelper {
    ...
    fun resizeTypeOf(context: Context,
                     @AspectRatioFrameLayout.ResizeMode resizeMode: Int): String {
    ...
    fun getTossFlingVelocity(context: Context): Int {
        return 2500
    }
    ...
    private fun getMinimizeOnExitAction(context: Context,
                                        key: String): String? {
