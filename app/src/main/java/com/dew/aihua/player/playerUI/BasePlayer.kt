...
import com.dew.aihua.player.helper.AudioReactor
import com.dew.aihua.player.helper.LoadController
...
import com.dew.aihua.util.SerializedCache
...
abstract class BasePlayer(protected val context: Context) : Player.EventListener, PlaybackListener,
    ...
    private val loadControl: LoadControl = LoadController(context)
