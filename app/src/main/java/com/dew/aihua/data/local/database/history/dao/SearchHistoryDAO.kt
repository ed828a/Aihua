...
import com.dew.aihua.data.local.database.history.model.SearchHistoryEntry.Companion.CREATION_DATE
import com.dew.aihua.data.local.database.history.model.SearchHistoryEntry.Companion.ID
import com.dew.aihua.data.local.database.history.model.SearchHistoryEntry.Companion.SEARCH
import com.dew.aihua.data.local.database.history.model.SearchHistoryEntry.Companion.SERVICE_ID
import com.dew.aihua.data.local.database.history.model.SearchHistoryEntry.Companion.TABLE_NAME
