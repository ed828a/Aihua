package com.dew.aihua.data.local.database.playlist.dao
...
import com.dew.aihua.data.local.database.playlist.model.PlaylistEntity.Companion.PLAYLIST_ID
import com.dew.aihua.data.local.database.playlist.model.PlaylistEntity.Companion.PLAYLIST_NAME
import com.dew.aihua.data.local.database.playlist.model.PlaylistEntity.Companion.PLAYLIST_TABLE
import com.dew.aihua.data.local.database.playlist.model.PlaylistEntity.Companion.PLAYLIST_THUMBNAIL_URL
import com.dew.aihua.data.local.database.playlist.model.PlaylistMetadataEntry
import com.dew.aihua.data.local.database.playlist.model.PlaylistMetadataEntry.Companion.PLAYLIST_STREAM_COUNT
import com.dew.aihua.data.local.database.playlist.model.PlaylistStreamEntity
import com.dew.aihua.data.local.database.playlist.model.PlaylistStreamEntity.Companion.JOIN_INDEX
import com.dew.aihua.data.local.database.playlist.model.PlaylistStreamEntity.Companion.JOIN_PLAYLIST_ID
import com.dew.aihua.data.local.database.playlist.model.PlaylistStreamEntity.Companion.JOIN_STREAM_ID
