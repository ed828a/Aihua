package com.dew.aihua.download.service
...
import com.dew.aihua.download.background.DownloadMissionManager
import com.dew.aihua.download.background.DownloadMissionManagerImpl
import com.dew.aihua.download.background.MissionControl
import com.dew.aihua.download.background.MissionControlListener
...
class DownloadManagerService : Service() {
    ...
    override fun onCreate() {
        ...
        paths.add(AppSettings.getVideoDownloadPath(this))
        paths.add(AppSettings.getAudioDownloadPath(this))
