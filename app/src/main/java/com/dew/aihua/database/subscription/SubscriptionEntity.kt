package com.dew.aihua.database.subscription

import androidx.room.*
import com.dew.aihua.database.subscription.SubscriptionEntity.Companion.SUBSCRIPTION_SERVICE_ID
import com.dew.aihua.database.subscription.SubscriptionEntity.Companion.SUBSCRIPTION_TABLE
import com.dew.aihua.database.subscription.SubscriptionEntity.Companion.SUBSCRIPTION_URL
 ...
 */
@Entity(tableName = SUBSCRIPTION_TABLE, indices = [Index(value = [SUBSCRIPTION_SERVICE_ID, SUBSCRIPTION_URL], unique = true)])
