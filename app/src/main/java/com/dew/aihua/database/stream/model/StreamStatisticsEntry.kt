...
class StreamStatisticsEntry(@field:ColumnInfo(name = StreamEntity.STREAM_ID)
                            ...
                            val thumbnailUrl: String, @field:ColumnInfo(name = StreamHistoryEntity.JOIN_STREAM_ID)
                            val streamId: Long, @field:ColumnInfo(name = STREAM_LATEST_DATE)
                            val latestAccessDate: Date,
                            @field:ColumnInfo(name = STREAM_WATCH_COUNT)
