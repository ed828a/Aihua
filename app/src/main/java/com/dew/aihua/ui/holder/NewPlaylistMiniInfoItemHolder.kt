 ...
 */
open class NewPlaylistMiniInfoItemHolder(infoItemBuilder: NewInfoItemBuilder, layoutId: Int, parent: ViewGroup) : NewInfoItemHolder(infoItemBuilder, layoutId, parent) {
    ...
    constructor(infoItemBuilder: NewInfoItemBuilder, parent: ViewGroup) : this(infoItemBuilder, R.layout.list_playlist_mini_item, parent)
    ...
    override fun updateFromItem(infoItem: InfoItem) {
        ...
        itemBuilder.displayImage(infoItem.thumbnailUrl, itemThumbnailView, ImageDisplayConstants.DISPLAY_THUMBNAIL_OPTIONS)
