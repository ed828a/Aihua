 ...
 */
open class SubscriptionsImportService : BaseImportExportService() {
    ...
    private val subscriber: Subscriber<List<SubscriptionEntity>>
        get() = object : Subscriber<List<SubscriptionEntity>> {
            ...
            override fun onComplete() {
                androidx.localbroadcastmanager.content.LocalBroadcastManager.getInstance(this@SubscriptionsImportService).sendBroadcast(
